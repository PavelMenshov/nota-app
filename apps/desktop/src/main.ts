      ...
      <body>
        <div class="container">
          ...
          <div class="steps">
            ...
            <ol>
              <li>Make sure the Nota web server is running on port 3000:<br><code>pnpm dev</code> or <code>pnpm dev:web</code></li>
              ...
              <li>Check that ports 3000 (web) and 4000 (API) are not blocked</li>
            </ol>
          </div>
